        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="page-header"><i class="fa fa-codepen" id="sidemenuicon"></i> Telenor <?php echo $lang_payment; ?></h2>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php foreach ($payment as $feed) {
                                        ?>
                                        <tr>
                                            <td><?php echo $feed->id; ?></td>
                                            <td><?php echo $feed->product_code; ?></td>
                                            <td><?php echo $feed->msisdn; ?></td>
                                            <td><?php echo $feed->charging_type; ?></td> 
                                            <td><?php echo $feed->renew_date; ?></td>
                                            <td><?php echo $feed->fee; ?></td>
                                            <td><?php echo $feed->reason; ?></td>
                                            <td><?php echo $feed->billing_id; ?></td>
                                             <td><?php echo $feed->processed_time; ?></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
