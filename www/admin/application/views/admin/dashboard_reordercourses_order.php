...
<body>
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-sort" id="sidemenuicon"></i> Re-order Courses</h2>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading sectionhead">
                        <form role="form" id="add_form" method="post" action="<?php echo site_url() ?>admin/Dashboard_courses/save_reodercourses">
                                                    ...
                                                    <?php foreach ($categories as $cat_row) { ?>
                                                        <li class="dd-item" data-id="<?php echo $cat_row->id ?>">
                                                            <div class="dd-handle">
                                                                ...
                                                                <div class="pull-left">
                                                                    <strong><?php 
																	echo ucfirst($cat_row->title); ?></strong>
                                                                </div>
                                                            </div>
                                                        </li> 
                                                        <?php
...
<?php else: ?>
                                                    <li class="dd-item" data-id="1">
                                                        <div class="dd-handle">
                                                            ...
                                                            <div class="pull-left">
                                                                <strong>courses not found.</strong>
                                                            </div>
                                                        </div>
                                                    </li> 
                                                <?php endif;
                        ...
                        <button type="submit" class="add_courses btn btn-primary">Submit</button>
                        
                        <a href="<?php echo site_url()?>admin/Dashboard_courses/index" style="float:right;color:#fff;" type="reset" class="btn btn closebtn">Cancel</a>
