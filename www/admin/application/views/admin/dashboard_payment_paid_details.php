                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div style="float:right; margin-top:-7px;"><button type="button" onclick="location.href='<?php echo base_url();?>admin/dashboard_payment/paid'" class="btn btn-primary">Back</button></div>
                        </div>
