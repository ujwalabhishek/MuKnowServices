...
<?php else: ?>
                        ...
                        <a href="<?php echo site_url()?>/admin/Dashbord_category/<?php echo $this->uri->segment(4)?>/<?php echo $this->uri->segment(5)?>" style="float:right;color:#fff;" type="reset" class="btn btn closebtn">Cancel</a>
