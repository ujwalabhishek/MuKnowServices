                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $payment['payment_fail_message']; ?></td>
                                            ...
                                            <td class="center"><button type="button" onclick="location.href='<?php echo base_url();?>admin/Dashboard_payment/cancel_details/<?php echo $payment['order_id']; ?>'" class="btn btn-primary btn-xs">Order Details</button></td>
                                        </tr>
                                        <?php
                                        }}
                                        ?>
