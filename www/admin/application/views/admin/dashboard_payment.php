                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php foreach ($payment as $feed) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $feed->Destination; ?></td>
                                            <td><?php echo $feed->Amount; ?></td>
                                            <td><?php echo $feed->Source; ?></td> 
                                            <td><?php echo $feed->RefNumber; ?></td>
                                            <td><?php echo $feed->MerchantName; ?></td>
                                            <td><?php echo $feed->environment; ?></td>
                                            <td><?php echo $feed->status; ?></td>
                                             <td><?php echo $feed->TransactionTime; ?></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
