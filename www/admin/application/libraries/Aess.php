...
class AesCtr extends Aess {
  ...
  public static function encrypt($plaintext, $password, $nBits) {
    ...
    $key = Aess::cipher($pwBytes, Aess::keyExpansion($pwBytes));
    ...
    $keySchedule = Aess::keyExpansion($key);
    //print_r($keySchedule);
    ...
    for ($b=0; $b<$blockCount; $b++) {
      ...
      $cipherCntr = Aess::cipher($counterBlock, $keySchedule);  // -- encrypt counter block --
