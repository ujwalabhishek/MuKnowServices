...
savePNGText:"Save as PNG",printText:"Print",days:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),shortDays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),months:"January February March April May June July August September October November December".split(" "),shortMonths:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}},ra={en:{}},ja={colorSet1:"#369EAD #C24642 #7F6084 #86B402 #A2D1CF #C8B631 #6DBCEB #52514E #4F81BC #A064A1 #F79647".split(" "),colorSet2:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #33558B".split(" "),
...
if(isNaN(l))throw SyntaxError("invalid date");"UTC:"===k.slice(0,4)&&(k=k.slice(4),q=!0);n=q?"getUTC":"get";var s=l[n+"Date"](),u=l[n+"Day"](),w=l[n+"Month"](),y=l[n+"FullYear"](),t=l[n+"Hours"](),v=l[n+"Minutes"](),aa=l[n+"Seconds"](),ca=l[n+"Milliseconds"](),x=q?0:l.getTimezoneOffset();return n=k.replace(a,function(a){switch(a){case "D":return s;case "DD":return N(s,2);case "DDD":return e[u];case "DDDD":return m[u];case "M":return w+1;case "MM":return N(w+1,2);case "MMM":return r[w];case "MMMM":return p[w];
case "Y":return parseInt(String(y).slice(-2));case "YY":return N(String(y).slice(-2),2);case "YYY":return N(String(y).slice(-3),3);case "YYYY":return N(y,4);case "h":return t%12||12;case "hh":return N(t%12||12,2);case "H":return t;case "HH":return N(t,2);case "m":return v;case "mm":return N(v,2);case "s":return aa;case "ss":return N(aa,2);case "f":return String(ca).slice(0,1);case "ff":return N(String(ca).slice(0,2),2);case "fff":return N(String(ca).slice(0,3),3);case "t":return 12>t?"a":"p";case "tt":return 12>
t?"am":"pm";case "T":return 12>t?"A":"P";case "TT":return 12>t?"AM":"PM";case "K":return q?"UTC":(String(l).match(g)||[""]).pop().replace(h,"");case "z":return(0<x?"-":"+")+Math.floor(Math.abs(x)/60);case "zz":return(0<x?"-":"+")+N(Math.floor(Math.abs(x)/60),2);case "zzz":return(0<x?"-":"+")+N(Math.floor(Math.abs(x)/60),2)+N(Math.abs(x)%60,2);default:return a.slice(1,a.length-1)}})}}(),fa=function(a,d,b){if(null===a)return"";a=Number(a);var c=0>a?!0:!1;c&&(a*=-1);var f=b?b.decimalSeparator:".",g=
...
0===u%q&&(l===r&&0<h.length)&&(b=g+b);else"E"!==d[0]&&"e"!==d[0]||"0"!==d[d.length-1]||!/[eE][+-]*[0]+/.test(d)?","===d?(l++,q=u,u=0,0<h.length&&(b=g+b)):b=1<d.length&&('"'===d[0]&&'"'===d[d.length-1]||"'"===d[0]&&"'"===d[d.length-1])?d.slice(1,d.length-1)+b:d+b:(d=0>s?d.replace("+","").replace("-",""):d.replace("-",""),b+=d.replace(/[0]+/,function(a){return N(s,a.length)}));c="";for(g=!1;0<m.length;)d=m.shift(),"#"===d||"0"===d?0<a.length&&0!==Number(a.join(""))?(c+=a.shift(),g=!0):"0"===d&&(c+=
...
y2:c+this.height}};U(Da,M);Da.prototype.render=function(){var a=this.chart.layoutManager.getFreeSpace();this.ctx.fillStyle="red";this.ctx.fillRect(a.x1,a.y1,a.x2,a.y2)};U(ba,M);ba.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||
...
"stackedLine100"===a||"stepArea"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeBar"===a||"rangeArea"===a||"rangeSplineArea"===a)return"square";if("line"===a||"stepLine"===a||"spline"===a||"pie"===a||"doughnut"===a||"funnel"===a)return"circle";if("area"===a||"splineArea"===a||"stackedArea"===a||"stackedArea100"===a)return"triangle";window.console.log("Unknown Chart Type: "+a);return null};ba.prototype.getDataPointAtX=function(a,d){if(!this.dataPoints||0===this.dataPoints.length)return null;
...
e.x1&&(a<=e.x2&&d>=e.y1&&d<=e.y2)&&(c.push({dataPoint:r,dataPointIndex:g,dataSeries:this,distance:Math.min(Math.abs(e.x1-a),Math.abs(e.x2-a),Math.abs(e.y1-d),Math.abs(e.y2-d))}),l=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=S("markerSize",r,this)||4,u=b?20:s,q=Math.sqrt(Math.pow(e.x1-a,2)+Math.pow(e.y1-d,2));q<=u&&c.push({dataPoint:r,dataPointIndex:g,dataSeries:this,distance:q});g=Math.abs(e.x1-
...
fontStyle:c[e].titleFontStyle,borderColor:c[e].titleBorderColor,borderThickness:c[e].titleBorderThickness,backgroundColor:c[e].titleBackgroundColor,cornerRadius:c[e].titleCornerRadius,textBaseline:"top"}));if("normal"===f){var u=[],w=[],v=[],t=[],G=[],H=[],J=[],M=[];if(a&&0<a.length)for(e=0;e<a.length;e++)a[e]&&a[e].title&&(a[e]._titleTextBlock.maxWidth=a[e].titleMaxWidth||g.width,a[e]._titleTextBlock.maxHeight=a[e].titleWrap?0.8*g.height:1.5*a[e].titleFontSize,a[e]._titleTextBlock.angle=0);if(d&&
...
d){ra[a]=d},formatNumber:function(a,d,b){b=b||"en";if(ra[b])return fa(a,d||"#,##0.##",new qa(b));throw"Unknown Culture Name";},formatDate:function(a,d,b){b=b||"en";if(ra[b])return Fa(a,d||"DD MMM YYYY",new qa(b));throw"Unknown Culture Name";}};Qa.Chart.version="v1.9.7 GA";window.CanvasJS=Qa})();
/*
