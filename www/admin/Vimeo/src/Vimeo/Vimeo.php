...
class Vimeo
{
    ...
    private $_client_id = '139f3e6ed400e912ed04bedf50880d2fdd808afd';
    private $_client_secret = 'L8H3LV0th3tiermH/uyT7rKgnz+j2PEYT9DXVKMKBUe883WGKjm0yUTCOl4ltHHv1NHaSsXkrzxzy/BqDSvaQQ9jYPguL7pULr159I0r7fHqE6M2qCRP52fPZoD0DoWE';
    private $_access_token = 'b23f2de1ffcadbe0162ee584bd2cd11e';
        ...
        switch ($method) {
            case 'GET':
                ...
                $curl_url = self::ROOT_ENDPOINT . $url . $query_component;
                               // echo '<pre>';print_r($curl_url); exit;
...
// echo '<pre>'; print_r($ticket); exit;
    ...
    { 
      ...
      // echo '<pre>'; print_r($completion); exit;
